...
public class CollectionHelper {
    ...
    /**
     *
     * @param route объект для проверки
     * @return true/false в зависимости от соответствия/несоответствия объекта требованиям
    ...
    public boolean deserializedObjectChecker(Route route) throws IllegalAccessException, NoSuchFieldException {
        for (Field f : route.getClass().getDeclaredFields()) {
            ...
            switch (fieldName) {
                case "id" -> {
                    if (getObjectById(Main.objects, (Long) f.get(route)) != null) {
